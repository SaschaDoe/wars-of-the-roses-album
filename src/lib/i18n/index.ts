...
export const translations = {
	en: {
		...
		bandHome: {
			...
			heroDescription: 'Epic battles, legendary figures, and dramatic turning points of medieval history brought to life through powerful concept albums. Each song is a gateway to the past, combining historically accurate storytelling with thundering metal soundscapes.',
			...
			aboutText: 'Uncivil War creates historically-inspired metal concept albums that transport listeners to pivotal moments in medieval history. The music combines meticulous historical research with powerful compositions, complete lyrics, and rich storytelling.',
		...
		about: {
			...
			quote: '"I believe that history deserves to be remembered, and what better way than through the power of music?"',
